...
<div class="travelinfo">
    ...
    <div class="rows">
        ...
        $b['bname']. '</span><br>
        <span style="color:#00a38d;font-size:16px;">'.$b['btype'].'</span><br>  <span style="text-align:center;font-size:19px;padding-left:960px;font-family:Alata;color:#02db97;"><b>'.$b['seats'].' Seats </b></span>
        <form action="seat.php?fare='.$b['fare'].'&busname='.$b['bname'].'&busid='.$b['b_id'].'" method = "post">
